    ...
    <section class="content">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <form action="" method="post" id="filmForm">
              <div class="row">
                  <div class="col-md-9">
                        <div class="form-group">
                          <input type="text" class="form-control" name="movieName" value="${movie.movieName}" placeholder="请输入电影名称">
                      	  <input type="hidden" class="form-control" id="movieId" name="movieId" value="${movie.id}" >
                      	
                      </div>
                      <div class="form-group">
                          <input type="text" class="form-control" name="directorName" value="${movie.directorName}" placeholder="请输入导演">
                      </div>
                      <div class="form-group">
                          <input type="text" class="form-control" name="area" value="${movie.area}" placeholder="请选择地区">
                      </div>
                      <div class="form-group">
                          <input type="text" class="form-control" name="year" value="${movie.year}" placeholder="请输入上映年份">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="box">
                          <div class="box-body">
                              <div id="preview" style="height: 138px;text-align:center"> 
                                <img alt="" id="img" src="${movie.imageName}" style="height:160px"/>
                              </div> 
               ...
               <div class="form-group"> 
                  <textarea name="content" class="from-control" id="editor"  placeholder="电影的内容简介...">${movie.simpleContent}</textarea>
               </div>
            </form>
  ...
  var editor = new Simditor({
    ...
    $("#filmForm").validate({
    	...
    	rules:{
    		movieName:{
    			required:true,
    			remote:"/check/movieName?id=" + $("#movieId").val()  //如果可用，返回ture
    		},
    		directorName:{
    			required:true
    		},
