...
<div class="box-body">
		...
		<div class="row">
			<div class="col-md-9">
				<div class="form-group">
					<input type="text" class="form-control" name="filmName" placeholder="请输入电影名称">
				</div>
				<div class="form-group">
					<input type="text" class="form-control" name="director" placeholder="请输入导演">
				</div>
				<div class="form-group">
				...
				<div class="box">
					<div class="box-body">
						<div id="preview" style="height: 138px; text-align: center">
							<img alt="" id="img" style="height: 150px" />
						</div>
	...
	<button id="btn" class="btn btn-primary">发布电影</button>
</div>
</div>
<!-- /.box -->
</section>
